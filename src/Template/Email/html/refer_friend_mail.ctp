...
<html>
    <head>
        ...
        <title>GoTribe::Forgot Password</title>
    </head>
                                ...
                                <tr>
                                    <td>
                                        <table cellpadding="0" cellspacing="0" align="left">
                                            ...
                                            <p>Your fiend <strong><?php echo $name;?></strong> < <?php echo $email;?> > referred you <strong>GoTribe</strong>.</p>
                                            <p style=" text-align:center;"><a href="<?php echo $link;?>" target="_blank" style="color: #444;">Register Now</a></p>
                                            <p>If you're having trouble clicking the password reset button, copy and paste the following link into your web browser.</p>
                                            <p><a href="<?php echo $link;?>" target="_blank" style="color: #444;"><?php echo $link;?></a></p>
                                            <p>&nbsp;</p>
                                            <p>&nbsp;</p>

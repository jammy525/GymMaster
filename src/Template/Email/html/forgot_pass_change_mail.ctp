...
<html>
    <head>
        ...
        <title>GoTribe::Password Changed</title>
    </head>
                                ...
                                <tr>
                                    <td>
                                        <table cellpadding="0" cellspacing="0" align="left">
                                            ...
                                            <p><strong>Congratulation! </strong>You have successfully changed your password that you recently requested for your <strong>GoTribe</strong> account</p>

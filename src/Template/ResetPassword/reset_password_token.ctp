...
<section class="content">
	...
	<div class="col-md-8 box box-default col-xs-offset-1 col-sm-10 col-sm-offset-1 col-md-offset-2">		
		...
		<?php				
			...
			echo "<fieldset><legend>". __('Change Password')."</legend>";			
			echo "<br>";
			echo "<div class='form-group'>";	
			echo '<label class="control-label col-md-2" for="password">'. __("Password").'</label>';
			echo '<div class="col-md-6">';			
			echo $this->Form->input("",["label"=>false,"id"=>"password", "type"=>"password","name"=>"password","class"=>"form-control validate[required]","value"=>""]);
			echo "</div>";				
			echo "</div>";
                        echo "<div class='form-group'>";	
			echo '<label class="control-label col-md-2" for="cpassword">'. __("Confirm Password").'</label>';
			echo '<div class="col-md-6">';			
			echo $this->Form->input("",["label"=>false, "type"=>"password","id"=>"cpassword","name"=>"cpassword","class"=>"form-control validate[required,equals[password]]","value"=>""]);
			echo "</div>";				
			echo "</div>";
			echo "</fieldset>";
			...
			echo $this->Form->button(__("Reset"),['class'=>"btn btn-flat btn-success","name"=>"reset"]);
                        ...
                        //echo '<p class="message"><a href="'.$this->request->base.'/user/login">'. __("Login").'</a>';

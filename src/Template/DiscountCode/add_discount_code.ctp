		...
		<form class="validateForm form-horizontal" method="post" role="form" onsubmit="return validate_multiselect()">		
              <input type="hidden" id="itsId" value="<?php echo ($edit) ? $data['id'] : '';?>">
                    <div class='form-group'>	
                        ...
                        <div class="col-md-6">
                            <input type="text" name="code" id="code" class="form-control validate[required,custom[onlyLetterNumber],ajax[isDiscountCodeUnique1]]" value="<?php echo (($edit)?$data['code']:'');?>">
                        </div>	
                    </div>
			...
			echo "</div>";	
                    ...
                    <div class='form-group'>	
                        ...
                        <div class="col-md-6">
                            <input type="text" name="valid_till" id="valid_till" class="form-control" value="<?php echo (($edit && isset($data['valid_till']) && $data['valid_till'] != '1')?(date($this->Gym->getSettings("date_format"),$data['valid_till'])):'');?>" readonly="eadonly">
                        </div>	
                    </div>

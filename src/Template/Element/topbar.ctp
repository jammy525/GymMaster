...
<div class="page-header navbar navbar-fixed-top">
                ...
                <div class="page-header-inner ">
                    ...
                    <div class="page-logo">
                        ...
                        <a href="">
                            <?php echo $this->Html->image($logo,["style"=>"max-height: 100%;max-width: 100%;",'class'=>"logo-default"]);?>
                        </a>  
                    ...
                    <div class="top-menu">
                        <ul class="nav navbar-nav pull-right">
                            ...
                            <li class="dropdown dropdown-user">
                                <a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-close-others="true">
                                    <?php $user_img = $session->read("User.profile_img");
					echo $this->Html->image("../webroot/upload/{$user_img}",array("class"=>"img-circle","alt"=>"User Image"));
                                        ?>                
                                   
                                    
                                    <span class="username username-hide-on-mobile"> <?php echo $session->read("User.name");?> </span>

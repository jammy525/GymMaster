                    ...
                    <div class="panel panel-white">
                        ...
                        <div class="panel-body">
                            <form class="validateForm form-horizontal" action="#" method="post">
                                ...
                                <div class="form-group">
                                    <label for="username" class="control-label col-sm-2"><?php echo __("Username");?></label>
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control " id="username" placeholder="Full Name" value="<?php echo $data["username"];?>" readonly="">
                                    </div>
                                </div>
                                                <div class="form-group">
                        ...
                        <div class="panel-heading">
                                                                ...
                                                                <div class="panel-body">
                                        <form class="validateForm form-horizontal" action="#" method="post" id="doctor_form">							
                                                ...
                                                <div class="form-group">
                                                        <label for="phone" class="control-label col-sm-2"><?php echo __("Phone");?><span class="text-danger">*</span></label>
                                                        <div class="col-sm-10">

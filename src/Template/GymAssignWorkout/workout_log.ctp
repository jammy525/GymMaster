			...
			foreach($data as $row)
			{
				echo "<tr>
					...
					<td>
						...
						<a href='".$this->request->base ."/GymAssignWorkout/deleteWorkout/{$row['user_id']}' class='btn btn-danger btn-flat' title='Delete' onclick=\"return confirm('Are you sure,You want to delete this record?');\"><i class='fa fa-trash'></i></a>
					</td>
				</tr>";
			}
			?>

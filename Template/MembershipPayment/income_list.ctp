				...
				if(!empty($data))
				{
					...
					{			
						echo "<tr>
								...
								<td>
								<a href='javascript:void(0)' class='btn btn-flat btn-default view_income_expense' data-url='".$this->request->base ."/GymAjax/viewIncomeExpense/{$row['id']}' type='income'><i class='fa fa-eye'></i></a>

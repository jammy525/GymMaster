			...
			foreach($data as $row)
			{
				...
				echo "<td>{$row['product_name']}</td>
					  ...
					  <td>
						...
						<a href='{$this->request->base}/GymProduct/deleteProduct' class='btn btn-flat btn-danger' title='".__('Delete')."' onclick=\"return confirm('Are you sure you want to delete this product?')\"><i class='fa fa-trash'></i></a>      
					  </td>";
				echo "</tr>";
			}
			?>
